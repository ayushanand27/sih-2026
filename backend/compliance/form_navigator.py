...
FORM_CATALOG: list[dict] = [
    {
        ...
        "keywords": [
            ...
            "bio-utilization",
            "bioutilisation",
            "research access to biological resource",
            "nba form 1",
            "access for research",
        ],
    ...
    },
    {
        ...
        "keywords": [
            ...
            "biological resource commercial",
            "nba form 2",
            "sell ayurvedic product commercially",
        ],
    ...
    },
    {
        ...
        "keywords": [
            "patent based on biological resource",
            "ipr based on biological resource",
            "nba approval for patent",
            "patent traditional knowledge",
            "biological resource patent",
            "nba prior approval patent",
            "section 6 approval",
            "patent my ayurvedic formulation",
        ],
        "formulation_categories": ["patent_and_proprietary"],
    ...
    },
    {
        ...
        "submission_portal": IPO_PORTAL,
        "required_attachments": [
            "Prescribed fee (concessional for natural persons/startups)"
        ],
        "deadline": "Any time before the ordinary 18-month publication date",
        "keywords": [
            "early publication",
            "publish patent application early",
            "section 11a",
        ],
        "formulation_categories": ["patent_and_proprietary"],
    },
...
def match_forms(
    ...
    for form in FORM_CATALOG:
        ...
        category_hit = bool(
            ...
            and formulation_category in form.get("formulation_categories", [])
        )
        tag_hit = bool(tags & set(form.get("statutory_tags", [])))

        if (keyword_hit or category_hit or tag_hit) and form[
            "form_id"
        ] not in matched_ids:
